...
# janus-idp.io/operator-bundle:$VERSION and janus-idp.io/operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= janus-idp.io/operator
...
.PHONY: podman-build
podman-build: init test ## Build podman image with the manager.
	podman build -t ${IMG} .
